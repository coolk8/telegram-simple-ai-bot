99% of code and data (incuding Readme file) in this repo was generated by [Cline](https://github.com/cline/cline). Also, thanks to [Aider](https://github.com/Aider-AI/aider) for leading the way.
